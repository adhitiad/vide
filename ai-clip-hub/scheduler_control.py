...
def execute_scheduled_task(job_name: str, epsilon: float = 0.2):
    ...
    if random.random() < epsilon:
        ...
        logger.info(f"🎯 [APSCHEDULER Eksploitasi] Memilih aksi terbaik: {topic} (Visual: {visual})")
...
def start_scheduler():
    ...
    scheduler.start()
    logger.info("📅 APScheduler berhasil diaktifkan. Menunggu jam tayang (07:30, 12:15, 19:00, 22:00 WIB)...")
    return scheduler
